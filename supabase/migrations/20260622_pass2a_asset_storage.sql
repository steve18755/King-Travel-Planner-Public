-- King Family Travel Planner - Pass 2A asset metadata and storage readiness
-- Run this in Supabase SQL Editor after confirming Pass 1 login/logout/save/load remains stable.
...
using (
  exists (
    select 1 from app.app_users au
...
-- Private object paths must start with household_id, for example:
